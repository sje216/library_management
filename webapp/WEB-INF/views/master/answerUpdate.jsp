		...
		<div class="FAdiv">
			<div class="FBdiv">
				<form action="updateAns">
					...
					<p>희망 도서 이름</p>
					<input type="text" name="ano" value="${ans.ano}" readonly="readonly">
					<!--이곳에 희망도서 이름 적는곳-->
					<p>희망 도서 설명</p>
					<!--이곳에 희망도서 에 대한 설명 적는곳-->
					<input type="text" name="answer" cols="50px" rows="10px" value="${ano.answer}">
					<hr style="border: black;">
					<input type="submit" onclick="alert('댓글 수정이 완료되었습니다.')" value="수정">
